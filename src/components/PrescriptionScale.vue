...
const leftWeight = computed(() => prescriptionStore.leftWeight)
const rightWeight = computed(() => prescriptionStore.rightWeight)
const currentHerb = computed(() => prescriptionStore.currentHerb)
const isBalanced = computed(() => prescriptionStore.isCurrentBalanced)
...
function updateWeights() {
  ...
  const leftPlaced = prescriptionStore.getPlacedWeights()
  const rightHerbCount = prescriptionStore.currentHerbCount
...
watch(
  () => [prescriptionStore.placedWeights.length, prescriptionStore.currentHerbCount],
  () => {
    updateWeights()
  },
  { deep: true }
